# para o correto funcionamento do código é necessário instalar a biblioteca ttkbootstrap 
# isso pode ser feito através do comando “pip install ttkbootstrap” no Prompt de Comando.
